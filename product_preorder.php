<div class="preorder-title">
        ...
        <div class="preorder-merch">
          <?php if (!empty($preorder_products)): ?>
            <?php foreach ($preorder_products as $product): ?>
              <a href="main_product.php?id=<?php echo htmlspecialchars($product['p_id']); ?>" style="text-decoration: none; color: inherit; display: contents;">
                <div class="preorder-item">
                  <img src="<?php echo htmlspecialchars($image_directory . $product['p_image_path']); ?>" alt="<?php echo htmlspecialchars($product['p_name']); ?>" class="product-image" />
          ...
          <?php elseif (!isset($db_error_message)): ?>
            <p style="text-align: center; width: 100%;">目前沒有預購商品。</p>
          <?php endif; ?>
        </div>