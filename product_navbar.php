...
?>
<nav class="navbar navbar-expand-lg navbar-light" style="background-color:#183c5d;">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="index_purchase.php">玩家特選周邊</a>
        </li>
        <li class="nav-item">
      ...
      <ul class="navbar-icon">
        <div class="nav-item">
          ...
          <?php } ?>
          <a class="nav-link" href="cart.php"><i class="fa-solid fa-basket-shopping"><span class="badge text-bg-info"><?php echo $cart_count; ?></span></i></a>
        </div>
      </ul>
    </div>
  </div>
